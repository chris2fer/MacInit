...
while options['sublime'] not in ['y', 'n']:
  options['sublime'] = raw_input("Do you want to install Visual Studio Code with Plugins? (%s)  " % '|'.join(['y','n']))
...
os.system('brew cask install google-chrome firefox sourcetree visual-studio-code slack')
...
show_notification("All done! Enjoy your new Mac :)")
